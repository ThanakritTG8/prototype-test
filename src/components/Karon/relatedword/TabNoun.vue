...
<script>
import WordCardNoun from "@/components/Karon/relatedword/WordCardNoun";
export default {
  name: "tab-noun",
  components: {
    WordCardNoun
  ...
  mounted() {
    this.$axios
      .get("https://sentimentanalysis.chochiang.com/tourist/beach/Auto-sentiment-web/API/karon/postgards/POSNOUN.json")      
      .then(({ data }) => {
        for (let key in data) {
          this.item = data;
