...
<script>
import Date from "@/components/Karon/dashboard/Date";
import CountComment from "@/components/Karon/dashboard/CountComment";
import CountPos from "@/components/Karon/dashboard/CountPos";
import CountNeg from "@/components/Karon/dashboard/CountNeg";
import AlltextSense from "@/components/Karon/dashboard/AlltextSense";
...
export default {
  ...
  mounted() {
    ...
    this.$axios.get("http://ajkitsiri.ddns.net/karon/counts/all").then(({ data }) => {
      for (const key in data) {
        this.countComment = data[key].numComment;
      }
   
    this.$axios.get("http://ajkitsiri.ddns.net/karon/counts/pos").then(({ data }) => {
      console.log(data);
      for (const key in data) {
    ...
    this.$axios.get("http://ajkitsiri.ddns.net/karon/counts/neg").then(({ data }) => {
      console.log(data);
      for (const key in data) {
